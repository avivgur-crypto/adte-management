      ...
      <div className="space-y-3">
        ...
        <div className="rounded-md bg-zinc-100 px-3 py-2 dark:bg-zinc-800/80">
          ...
          <div className="mt-1 flex items-baseline justify-between gap-2 text-[11px] text-zinc-500 dark:text-zinc-400">
            ...
            <PaceBadge percent={projectedVsGoalPercent} trend={trend} />
          </div>
        </div>
  ...
  return (
    <div className="w-full max-w-4xl rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-950">
      ...
      <div className="grid gap-4 sm:grid-cols-3">
        <SectionBlock title="Total revenue" section={summary.total} trend={summary.trend.total} />
        <SectionBlock title="Media (from Xdash)" section={summary.media} trend={summary.trend.media} />
        <SectionBlock title="SaaS (from Billing)" section={summary.saas} trend={summary.trend.saas} />
      </div>
